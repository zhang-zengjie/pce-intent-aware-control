...
if False:
    ...
    np.save('results/case_2/comp/xx_ego_seed_' + str(j) + '_c.npy', xx_ego[:, :, j])
    np.save('results/case_2/comp/xx_oppo_seed_' + str(j) + '_c.npy', xx_oppo[:, :, j])
    np.save('results/case_2/comp/xx_pedes_seed_' + str(j) + '_c.npy', xx_pedes[:, :, j])
    ...
    j = 0
    xx_ego[:, :, j] = np.load('results/case_2/comp/xx_ego_seed_' + str(j) + '_c.npy')
    xx_oppo[:, :, j] = np.load('results/case_2/comp/xx_oppo_seed_' + str(j) + '_c.npy')
    xx_pedes[:, :, j] = np.load('results/case_2/comp/xx_pedes_seed_' + str(j) + '_c.npy')
